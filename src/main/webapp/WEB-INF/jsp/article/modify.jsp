...
<body>
	...
	<main class="flex justify-center w-full ">
		<form action="/article/doModify" method="POST"
			...
			<input tpye="hidden" name="id" value="${article.id}" />
			<div class="flex w-full">
				<p class="w-20">타이틀</p>
				<label class="input input-bordered flex items-center gap-2 w-full">

					<input type="text" class="grow" placeholder="타이틀" name="title" value="${article.title} }"/>
				</label>
			</div>

				<p class="w-15">내용</p>
				<textarea class="textarea textarea-warning w-full" placeholder="내용" name="body">${article.body}</textarea>
